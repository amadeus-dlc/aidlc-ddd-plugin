...
- Invoke `bun .kimi-code/tools/aidlc.ts engine worktree` from the main repo checkout; `aidlc-worktree` itself emits the audit event audit-first before invoking git
