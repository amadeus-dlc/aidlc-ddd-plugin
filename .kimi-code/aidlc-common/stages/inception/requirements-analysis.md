...
`bun .kimi-code/tools/aidlc.ts engine orchestrate report --stage requirements-analysis --result <outcome>`.
...
`bun .kimi-code/tools/aidlc.ts engine recompose --add user-stories`
