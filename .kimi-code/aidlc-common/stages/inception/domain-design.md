...
`bun .kimi-code/tools/aidlc.ts engine orchestrate report --stage domain-design --result <outcome>`.
...
`bun .kimi-code/tools/aidlc.ts engine recompose --add units-generation`
