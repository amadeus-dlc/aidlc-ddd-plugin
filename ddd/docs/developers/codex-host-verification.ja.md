...
このページと下記JSONは、2026年9月の旧Codex連携を調べた履歴である。**現在のAI-DLC 2.9.0でルール転送が動くという証明には使わない。** 現在の対応方針は[互換性](framework-compatibility.ja.md)、再検証は[T-05](completion-tasks.ja.md)を参照する。
